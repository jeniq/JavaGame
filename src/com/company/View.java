...
public class View {
    ...
    public static final String ASK_MIN_VALUE = "Please enter minimum possible value (should be 0 or more): ";
    public static final String ASK_MAX_VALUE = "Please enter maximum possible value (should be 100 or less): ";
    public static final String WRONG_MAX_VALUE = "Please enter maximum value 100 or less: ";
    public static final String WRONG_MIN_VALUE = "Please enter minimum value 0 or more:";
